...
const CheckpointResultPage: React.FC = () => {
  ...
  const isPassed = attempt.percentage >= 80;
  const isListening = attempt.category === 'listening';
  const displayLevel = getLevelGroup(attempt.avLevel);
        ...
        <div className="mb-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-10">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 tracking-tight mb-4">
              Kết quả <span className={clsx("text-transparent bg-clip-text bg-gradient-to-r", theme.gradient)}>Checkpoint</span>
            </h1>
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] border border-white/60 shadow-xl shadow-slate-200/50 overflow-hidden mb-8 relative">
          ...
          <div className="p-8 md:p-12 flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            <div className="flex flex-col gap-4 w-full lg:w-80">
              <Button
                variant="primary"
                onClick={() => navigate(`/roadmap/checkpoint/review/${resultId}`, { state: { result: attempt } })}
                className={clsx(
              ...
              <Button
                variant="ghost"
                onClick={() => navigate(`/roadmap/checkpoint/${testId}`)}
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-100">
                    ...
                    <span className="font-bold text-slate-900">{new Date(attempt.startedAt).toLocaleDateString('vi-VN')}</span>
                  </div>
                </div>
              </div>
            </div>
...
export default CheckpointResultPage;
