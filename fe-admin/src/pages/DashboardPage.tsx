  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Tổng quan về hệ thống kiểm tra đầu vào</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="mt-4 flex items-center text-sm">
            <span className="text-green-600 font-medium">+{stats?.totalTests || 0}</span>
            <span className="text-gray-600 ml-1">bài test</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600">Bài test đang hoạt động</p>
          ...
          <div className="mt-4 flex items-center text-sm">
            <span className="text-green-600 font-medium">{((stats?.activeTests || 0) / (stats?.totalTests || 1) * 100).toFixed(0)}%</span>
            <span className="text-gray-600 ml-1">của tổng số test</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600">Test Listening</p>
          ...
          <div className="mt-4 flex items-center text-sm">
            ...
            <span className="text-gray-600 ml-1">skill test</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600">Test Reading</p>
          ...
          <div className="mt-4 flex items-center text-sm">
            <span className="text-yellow-600 font-medium">Reading</span>
            <span className="text-gray-600 ml-1">skill test</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900">Thống kê theo loại</h3>
          </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-left">
              ...
              <p className="font-medium text-gray-900">Tạo Test Mới</p>
              <p className="text-sm text-gray-600">Tạo bài kiểm tra mới</p>
            </button>
            ...
            <button className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-left">
              ...
              <p className="text-sm text-gray-600">Học sinh & Admin</p>
            </button>
