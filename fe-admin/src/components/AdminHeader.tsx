        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100"
            >
            ...
            {showUserMenu && (
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50">
                ...
                >
                  <div className="flex items-center">
                    <svg className="w-4 h-4 mr-3 text-danger-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
